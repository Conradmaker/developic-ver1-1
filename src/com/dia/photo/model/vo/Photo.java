...
public class Photo {
	...
	public Photo(int photoId, String photoName, int photoSale, int photoPrice, Date photoCreatedAt, String photoSrc,
			String photoInfo, Date photoUpdatedAt, int categoryId, int userNo, String userName, String userNickname) {
		super();
	...
	public String toString() {
		return "Photo [photoId=" + photoId + ", photoName=" + photoName + ", photoSale=" + photoSale + ", photoPrice="
				...
				+ photoInfo + ", photoUpdatedAt=" + photoUpdatedAt + ", categoryId=" + categoryId + ", userNo=" + userNo
