...
/**
 * Servlet implementation class ShopCategoryListController
 */
@WebServlet("/shopCateList.ph")
public class ShopCategoryListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShopCategoryListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// PICSHOP 게시판 리스트 조회 
		ArrayList<Photo> list = new ShopService().selectShopCateList(pi, category);
