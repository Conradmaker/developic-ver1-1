...
public class PageInfo {
	...
	private int listCount;			// PICSHOP 게시판 게시글 총 갯수
	private int currentPage;		// 사용자가 요청한 페이지 (=현재 페이지)
	private int pageLimit;			// 한 페이지 하단에 보여질 페이지 최대갯수 (5)
	private int boardLimit; 		// 한 페이지 내에 보여질 게시글 최대갯수 (9)
