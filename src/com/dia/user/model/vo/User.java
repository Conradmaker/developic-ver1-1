...
public class User {
		...
		public User(int userNo, String userId, String userName, String userNickname, String phone, String email,
				String sns, String userInfo, String userAvatarSrc, int userRole) {
			super();
			this.userNo = userNo;
			this.userId = userId;
